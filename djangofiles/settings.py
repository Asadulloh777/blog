...
SECRET_KEY = 'django-insecure-z9y%)8_(+zw_$yw((1t^97eg$*)c!mnjp&v%5^l!0f==!gdwlp'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['odiljonovasadulloh.tk', 'www.odiljonovasadulloh.tk']
...
MEDIA_URL = 'media/'
MEDIAFILES_DIRS = os.path.join(BASE_DIR, '')
STATIC_ROOT = ''
MEDIA_ROOT = ''
